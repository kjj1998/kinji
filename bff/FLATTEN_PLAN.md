> **SUPERSEDED by [LAYERED_PLAN.md](LAYERED_PLAN.md)** — the project chose the flat layered layout instead, and it has been implemented. This plan is kept for historical reference only.
